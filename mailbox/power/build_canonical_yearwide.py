...
round1p5 pattern (re-inject CSV files in mailbox/20260505/).
...
Usage:
    python mailbox/power/build_canonical_yearwide.py \\
        --csv "mailbox/power/20260507/<wide_csv>" \\
        --out-dir mailbox/power/20260507/ \\
        --tag rev1
"""
