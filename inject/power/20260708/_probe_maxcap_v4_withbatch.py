...
for _bf in ["inject/power/20260708/power_batch1_delta_20260708.csv","inject/power/20260708/power_batch1b_endogenous_ATS_BAS_delta_20260708.csv","inject/power/20260708/exo_negative_fix_ats_delta.csv"]:
    for r in csv.DictReader(open(REPO / _bf, encoding="utf-8-sig")):
        if r["variable"].strip() in VARS:
            put(r["ams"].strip(), leaf(r["branch"]), r["variable"].strip(), r["scenario"].strip(), r["expression"], "L5-batch")
