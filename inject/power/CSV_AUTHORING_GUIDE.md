...
> them into `inject/power/<YYYYMMDD>/`. Run `build_canonical.py` over
> them. Inject the resulting `*_canonical.csv` with the standard
> [`inject/bioenergy/inject_to_leap.py`](../bioenergy/inject_to_leap.py)
...
[`result/20260505/INJECTS_TO_REPLICATE.md`](../20260505/INJECTS_TO_REPLICATE.md)
...
python inject/power/run_workflow.py \
    --csv inject/power/20260507/ats_exo_formula_canonical.csv \
...
#    scenario via result/20260505/_probe_readback_one.py — extend
...
**Use `run_workflow.py`, not `inject/bioenergy/inject_to_leap.py`,
...
- **2026-05-07 — from results-harvest cycle:** Always exclude
  ...
  [result/20260505/RESULTS_HARVEST_SOP.md](../20260505/RESULTS_HARVEST_SOP.md).
...
- **2026-05-07 — from v0.38 inject cycle (this domain):** LEAP COM
  ...
  [result/20260505/_probe_readback_one.py](../20260505/_probe_readback_one.py)
  for the pattern.
